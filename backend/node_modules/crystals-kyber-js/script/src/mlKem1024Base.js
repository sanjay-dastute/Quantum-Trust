(function (factory) {
     ...
     */
    class MlKem1024Base extends mlKemBase_js_1.MlKemBase {
        constructor() {
            super();
        ...
        _decompressU(a) {
            ...
            for (let i = 0; i < this._k; i++) {
                r[i] = new Int16Array(consts_js_1.N);
            }
            const t = new Array(8);
            for (let aa = 0, i = 0; i < this._k; i++) {
                for (let j = 0; j < consts_js_1.N / 8; j++) {
                    ...
                    aa = aa + 11;
                    for (let k = 0; k < 8; k++) {
                        r[i][8 * j + k] = ((t[k] & 0x7FF) * consts_js_1.Q + 1024) >> 11;
                    }
                }
            }
            return r;
         ...
         */
        _decompressV(a) {
            const r = new Int16Array(consts_js_1.N);
            const t = new Array(8);
            for (let aa = 0, i = 0; i < consts_js_1.N / 8; i++) {
                ...
                aa = aa + 5;
                for (let j = 0; j < 8; j++) {
                    r[8 * i + j] = (0, utils_js_1.int16)((((t[j] & 31) * consts_js_1.Q) + 16) >> 5);
                }
            }
            return r;
        }
    }
    exports.MlKem1024Base = MlKem1024Base;
});
